...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ('username', 'displayname', 'email', 'pfp')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        fields = ('username', 'displayname', 'email', 'password', 'is_active', 'is_admin')
...
class UserAdmin(UserAdmin, admin.ModelAdmin):
    ...
    list_display = ('username', 'displayname', 'email', 'password', 'is_active', 'is_admin')
    list_filter = ('is_admin',)
    fieldsets = (
        (None, {'fields': ('username', 'password')}),
        ('Personal info', {'fields': ('displayname', 'pfp')}),
